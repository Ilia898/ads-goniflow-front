                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                <input
                                    ...
                                    className="block w-full rounded-xl border border-slate-800 bg-slate-950/50 pl-4 pr-12 py-3 text-slate-100 placeholder-slate-500 shadow-inner outline-none transition-all focus:border-indigo-500/50 focus:ring-2 focus:ring-indigo-500/20 sm:text-sm disabled:opacity-30 disabled:pointer-events-none"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
                                    ...
                                    className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-300 transition-colors focus:outline-none disabled:opacity-30"
                                >
                                    {showPassword ? (
